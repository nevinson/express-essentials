const BaseAutoBindedClass = require('../base/base-autobind'),
    JwtRsStrategy = require('../authstrategy/jwt-rs'),
    SecretKeyAuth = require('../authstrategy/secret-key'),
    CredentialsAuth = require('../authstrategy/credentials'),
    ExtractJwt = require("passport-jwt").ExtractJwt,
    JwtToken = require('../models/auth/jwt-token'),
    RevokedToken = require('../models/auth/revoked-token').RevokedTokenModel,
