const RevokedToken = require('../model/auth/revoked-token').RevokedTokenModel,
    NotFoundError = require('../error/invalid-payload'),
...
class AuthHandler extends BaseAutoBindedClass {
    constructor() {
        ...
        this._authManager = require('../manager/auth');
    }
